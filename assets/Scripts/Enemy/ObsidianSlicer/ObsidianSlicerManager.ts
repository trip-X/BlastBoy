...
import { ObsidianSlicerStateMachine } from './ObsidianSlicerStateMachine'
...
@ccclass('ObsidianSlicerManager')
export class ObsidianSlicerManager extends EnemyManager {
  ...
  async init(params: IEntity, stats: IEnemyStats): Promise<void> {
    ...
    this.fsm = this.addComponent(ObsidianSlicerStateMachine)
    await this.fsm.init()
